...
mentors_df['features'] = mentors_df['characteristic']+ ' ' + mentors_df['hobbies'] + ' ' + \
                          mentors_df['loc'] + ' ' + mentors_df['lang'] + ' ' + \
                          mentors_df['p_lang'] + ' ' + mentors_df['job']
